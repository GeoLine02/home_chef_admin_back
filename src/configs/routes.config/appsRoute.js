...
const appsRoute = [
    ...
    {
        key: 'appSales.restaurantNew',
        path: `${APP_PREFIX_PATH}/sales/restaurant-new`,
        component: React.lazy(() => import('views/sales/RestaurantNew')),
        authority: [ADMIN, USER],
        meta: {
            haeder: 'Add New Restaurant',
        },
    },
    {
        key: 'appsSales.restaurantEdit',
        path: `${APP_PREFIX_PATH}/sales/restaurant-edit/:restaurantId`,
        component: React.lazy(() => import('views/sales/RestaurantEdit')),
        authority: [ADMIN, USER],
        meta: {
    ...
    {
        key: 'appsSales.restaurantList',
        path: `${APP_PREFIX_PATH}/sales/restaurant-list`,
        component: React.lazy(() => import('views/sales/restaurantList')),
        authority: [ADMIN],
        meta: {
            haeder: 'Edit restaurant',
        },
    },
    {
